...
const backgroundSpritePath =
    "../assets/imgs/backgrounds/cachoeira_1024x576.jpg";
...
class Sprite {
    ...
    draw() {
        ...
        ctx.scale(xScale, 1); // vira a sprite pra onde esta olhando

        ctx.drawImage(
            this.image,
            (this.currentSpriteFrame * this.image.width) /
                this.totalSpriteFrames,
            0,
...
class Fighter extends Sprite {
    constructor({ position, velocity, attackBox, sprites, scale, life }) {
        super({
            position,
            velocity,
            scale,
        ...
        this.lastKeyPressed;
        this.onGround;
        this.life = life || 100; // VIDA INICIAL
    }
